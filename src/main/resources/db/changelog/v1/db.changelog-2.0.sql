...
CREATE TYPE credit_type AS ENUM ('AUTO', 'PERSONAL', 'BUSINESS', 'MORTGAGE');
...
SELECT
    ...
    (ARRAY['AUTO', 'PERSONAL', 'BUSINESS', 'MORTGAGE'])[floor(random() * 4 + 1)::INT]::credit_type,
    gs.client_id
FROM
    generate_series(1, 50) AS gs(client_id);
--changeset merkodanov:4
